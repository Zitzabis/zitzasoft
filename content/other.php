<div class="panel">
    ...
    <div class="row rowPad">
        <div class="col panel">
            <div>
                <h5>Cisco Catalyst Switch Scanner</h5>
                Status: <span class="text-success">Completed</span>
                <br>
                GitHub: <a href="https://github.com/Zitzabis/cisco-switch-scanner">https://github.com/Zitzabis/cisco-switch-scanner</a>
            </div>
            <div class="rowPad">
                Requested by the Network Administrator of Southern Wesleyan University.
                <br>
                <br>
